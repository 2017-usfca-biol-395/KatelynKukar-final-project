...
**Figure 4**:
```{r, metric to visualize microbiota}
plot_bar(pruned_phyloseq,
         x = "BRD_affected_or_healthy_s",
         y = "Abundance",
         fill = "Phylum",
         title = "Abundance of Healthy or Affected Samples",
         facet_grid = NULL)
```
Figure 4 looks at the distribution of Phylums throughout the samples tested to see the different types of bacteria represented in the respiratory tract of the calves.
...
```
```
Figure 6: The observed Ordination, which distinguishes healthy and BRD affected calves, shows a level of relatedness for the healthy calf microbiome, but a large spread witin affected calf microbiome.
