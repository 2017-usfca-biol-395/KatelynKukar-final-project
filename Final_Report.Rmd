...
Table 2 looks at the most relevant genera for affected versus healthy tissue types. 57.14% more bacteria for each type is visualized in affected samples than healthy samples for all tested genuses.
