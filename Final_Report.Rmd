...
All sample origins and sequencing were done by Johnston et al. and associated authors to obtain the data utilized throughout this analysis.
...
In all resulting statistical analyses the phyloseq object and melted object are applied to use ggplot2 in making tables and figures [@wickham2011ggplot2]. The pruning function removes Not Applicable data in some cases [Cite R Core Team].
